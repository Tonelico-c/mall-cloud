...
//    private static final String dbTables = "admin,course,coach,reserve,user";             //需要生成的表名
    private static final String dbTables = "order_item";             //需要生成的表名
    private static final Boolean enableSwagger = false;                 //是否开启Swagger

    public static void main(String[] args) {
        // 1.数据源配置
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/mall","root","050622").build();
        ...
        globalConfigBuilder.outputDir(projectPath + "/mall-order" + "/src/main/java");
        // 作者
